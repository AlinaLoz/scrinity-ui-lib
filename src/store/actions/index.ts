...
export function addUserMessage(text: string, id?: string, timestamp?: string | null): actionsTypes.AddUserMessage {
  return {
...
export function addResponseMessage(text: string, id?: string, timestamp?: string | null): actionsTypes.AddResponseMessage {
  return {
