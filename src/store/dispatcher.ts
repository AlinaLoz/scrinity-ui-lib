...
export function addUserMessage(text: string, id?: string, timestamp: string | null = null) {
  store.dispatch(actions.addUserMessage(text, id, timestamp));
}

export function addResponseMessage(text: string, id?: string, timestamp: string | null = null) {
