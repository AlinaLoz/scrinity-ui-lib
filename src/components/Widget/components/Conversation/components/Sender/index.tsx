...
const send = require('../../../../../../../assets/images/send_button.svg') as string;
const emoji = require('../../../../../../../assets/images/icon-smiley.svg') as string;
const brRegex = /<br>/g;
  ...
  return (
    <div ref={refContainer} className="rcw-sender">
      ...
      <button type="submit" className="rcw-send" onClick={handlerSendMessage}>
        <img src={send} className="btn-rcw-send-icon" alt={buttonAlt} />
      </button>
    </div>
  );
}
