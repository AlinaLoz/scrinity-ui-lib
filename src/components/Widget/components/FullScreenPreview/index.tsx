...
const close = require('../../../../../assets/images/close.svg') as string;
const plus = require('../../../../../assets/images/plus.svg') as string;
const minus = require('../../../../../assets/images/minus.svg') as string;
const zoomIn = require('../../../../../assets/images/zoom-in.svg') as string;
const zoomOut = require('../../../../../assets/images/zoom-out.svg') as string;
