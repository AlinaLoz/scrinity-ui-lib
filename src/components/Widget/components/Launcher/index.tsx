...
const openLauncher = require('../../../../../assets/images/launcher_button.svg') as string;
...
function Launcher({ toggle, chatId, openImg, closeImg, openLabel, closeLabel, showBadge }: Props) {
  ...
  return (
    <button type="button" className={cn('rcw-launcher', { 'rcw-hide-sm': showChat })} onClick={toggleChat} aria-controls={chatId.toString()}>
